...
use serde_json::json;
use turboclaude::{BatchRequest, TokenCount, types::*};
...
fn test_message_serialization() {
    let message = Message {
        ...
        model: models::CLAUDE_SONNET_4_5_20250514.to_string(),
    ...
    assert_eq!(json["model"], models::CLAUDE_SONNET_4_5_20250514);
...
fn test_message_request_builder() {
    ...
    assert_eq!(request.model, models::CLAUDE_3_5_SONNET_20241022);
...
fn test_message_request_serialization() {
    ...
    assert_eq!(json["model"], models::CLAUDE_3_5_SONNET_20241022);
...
fn test_model_serialization() {
    ...
    assert_eq!(json["id"], models::CLAUDE_SONNET_4_5_20250514);
...
fn test_token_count_serialization() {
    let token_count = TokenCount { input_tokens: 123 };
